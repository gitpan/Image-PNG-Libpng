...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.38_01/examples/synopsis.pl">Download  "synopsis.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.38_01/examples/get-www-png.pl">Download  "get-www-png.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.38_01/examples/png-cgi.pl">Download  "png-cgi.pl" here</a>.)
...
<p>
<img src='http://www.lemoda.net/png/png-cgi/png.cgi' width=100 height=100 alt='png image generated by the above script'>
</p>
...
Copy a PNG from a read to a write structure. There are two kinds of
object created by this module, "read a png" objects created by
L</create_read_struct> and "write a png" objects created by
L</create_write_struct>. This copies all the valid chunks from a read
structure to a write structure.
...
L</bKGD>, L</cHRM>, L</gAMA>, L</hIST>, L</hIST>, L</iCCP>, L</IDAT>, L</IHDR>, L</iTXt>, L</oFFs>, L</pCAL>, L</pHYs>, L</PLTE>, L</sBIT>, L</sCAL>, L</sPLT>, L</sRGB>, L</tEXt>, L</tIME>, L</tRNS>, and L</zTXt>.
...
This function corresponds to C<png_get_IHDR>, with a single Perl hash reference used
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.38_01/examples/color-type-name.pl">Download  "color-type-name.pl" here</a>.)
...
This function corresponds to C<png_get_image_width>
...
This function corresponds to C<png_get_image_height>
...
This function corresponds to C<png_get_channels>
...
This function corresponds to C<png_get_bit_depth>
...
This function corresponds to C<png_get_interlace_type>
...
This sets the text chunks in an array reference C<$text_chunks>. . The input value is an array reference containing hash references. Each hash reference must have the following keys:
...
This function corresponds to C<png_set_user_limits>
...
This function corresponds to C<png_get_user_width_max>
...
This function corresponds to C<png_get_user_height_max>
...
This function corresponds to C<png_set_filler>
...
This function corresponds to C<png_set_packing>
...
This function corresponds to C<png_set_strip_16>
...
This function corresponds to C<png_set_expand>
...
This function corresponds to C<png_set_gray_to_rgb>
...
This function corresponds to C<png_set_gray_to_rgb_fixed>
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.38_01/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
