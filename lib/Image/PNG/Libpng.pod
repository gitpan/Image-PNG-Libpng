...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.31/examples/synopsis.pl">Download  "synopsis.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.31/examples/get-www-png.pl">Download  "get-www-png.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.31/examples/png-cgi.pl">Download  "png-cgi.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.31/examples/color-type-name.pl">Download  "color-type-name.pl" here</a>.)
...
like the following:
	...
	cinfo = INT2PTR (png_info *, SvIV (SvRV (info));
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.31/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
