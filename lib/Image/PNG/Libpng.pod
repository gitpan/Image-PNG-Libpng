...
Does the libpng support the L</sCAL> extension?
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.28_02/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
