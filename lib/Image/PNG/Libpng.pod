...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.28_07/examples/synopsis.pl">Download  "synopsis.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.28_07/examples/get-www-png.pl">Download  "get-www-png.pl" here</a>.)
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.28_07/examples/png-cgi.pl">Download  "png-cgi.pl" here</a>.)
...
object in this module, those created by L</create_read_struct> and
those created by L</create_write_struct>. This just copies all the
chunks from one to the other.
...
(<a href="http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.28_07/examples/color-type-name.pl">Download  "color-type-name.pl" here</a>.)
...
This function corresponds to C<png_get_image_>
...
you can find each instance L<in the file C<perl-libpng.c> in the top directory of the distribution|http://cpansearch.perl.org/src/BKB/Image-PNG-Libpng-0.28_07/perl-libpng.c> in the macro
C<UNUSED_ZERO_ARG>.
